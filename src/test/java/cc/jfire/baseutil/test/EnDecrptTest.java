...
import cc.jfire.baseutil.encrypt.AesUtil;
import cc.jfire.baseutil.encrypt.DesUtil;
import cc.jfire.baseutil.encrypt.EnDecrpt;
import cc.jfire.baseutil.encrypt.RSAUtil;
...
public class EnDecrptTest
{
    ...
    public void testRsa()
    {
        RSAUtil rsaUtil   = new RSAUtil("SHA1WithRSA");
