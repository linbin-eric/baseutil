...
import xin.nb1.baseutil.reflect.valueaccessor.GetInt;
import xin.nb1.baseutil.reflect.valueaccessor.ValueAccessor;
import xin.nb1.baseutil.reflect.valueaccessor.impl.LambdaAccessorImpl;
import xin.nb1.baseutil.smc.compiler.CompileHelper;
import xin.nb1.baseutil.smc.compiler.ecj.ECJCompiler;
import xin.nb1.baseutil.smc.compiler.jdk.JDKCompiler;
import lombok.Data;
...
public class ValueAccessorTest
{
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
            ...
            {(Function<Field, ValueAccessor>) field -> ValueAccessor.compile(field, new CompileHelper(Thread.currentThread().getContextClassLoader(), new JDKCompiler())), "JavacCompiler"},
