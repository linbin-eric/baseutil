...
public final class Uninterruptibles
{
    ...
    // java.time.Duration
    public static <V extends Object> V getUninterruptibly(Future<V> future, Duration timeout) throws ExecutionException, TimeoutException
    {
    ...
    // TODO
    @SuppressWarnings("GoodTime") // should accept a java.time.Duration
    public static <V extends Object> V getUninterruptibly(Future<V> future, long timeout, TimeUnit unit) throws ExecutionException, TimeoutException
    {
        boolean interrupted = false;
        try
        {
