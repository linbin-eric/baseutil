...
public final class MurmurHash3
{
     ...
     * than 2x faster than hashing the result of String.getBytes().
     */
    public static int murmurhash3_x86_32(CharSequence data, int offset, int len, int seed)
    {
        ...
        while (pos < end)
        {
            ...
            if (code < 0x80)
            {
                 ...
                 * k1 = (k1 << 15) | (k1 >>> 17); // ROTL32(k1,15); k1 *= c2; h1
                 * ^= k1; h1 = (h1 << 13) | (h1 >>> 19); // ROTL32(h1,13); h1 =
            ...
            {
                // we check for pos>=end to encode an unpaired surrogate as 3
                // bytes.
