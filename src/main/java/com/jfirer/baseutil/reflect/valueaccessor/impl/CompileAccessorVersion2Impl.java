...
import static com.jfirer.baseutil.reflect.ReflectUtil.PRIMITIVE_BOOL;

public class CompileAccessorVersion2Impl implements ValueAccessor
{
    private       Field                      field;
    ...
    public CompileAccessorVersion2Impl(Field field)
    {
        this.field = field;
