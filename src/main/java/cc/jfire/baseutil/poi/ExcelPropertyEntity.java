...
import static cc.jfire.baseutil.poi.ExcelPoiUtil.getCellValueAsString;
...
public class ExcelPropertyEntity
{
    ...
    protected void writeValue(Cell cell, Object value)
    {
        ...
        switch (classId)
        {
            case ReflectUtil.PRIMITIVE_BYTE, ReflectUtil.PRIMITIVE_SHORT, ReflectUtil.PRIMITIVE_INT, ReflectUtil.PRIMITIVE_LONG, ReflectUtil.CLASS_BYTE, ReflectUtil.CLASS_SHORT,
                 ReflectUtil.CLASS_INT, ReflectUtil.CLASS_LONG ->
            {
                cell.setCellValue(((Number) value).doubleValue());
            }
            case ReflectUtil.PRIMITIVE_FLOAT, ReflectUtil.PRIMITIVE_DOUBLE, ReflectUtil.CLASS_FLOAT, ReflectUtil.CLASS_DOUBLE ->
            {
                cell.setCellValue(((Number) value).doubleValue());
            }
