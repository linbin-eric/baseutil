...
import static com.jfirer.baseutil.reflect.ReflectUtil.UNSAFE;
...
{
    private final static long VALUE_OFFSET = UNSAFE.objectFieldOffset(PaddedAtomicLongL1Field.class, "value");
    ...
    {
        UNSAFE.putLongRelease(this, VALUE_OFFSET, v);
    }
    ...
    {
        return UNSAFE.compareAndSetLong(this, VALUE_OFFSET, expectedV, newV);
    }
