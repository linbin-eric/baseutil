...
{
    final static     long               P_NODE_OFFSET = UNSAFE.objectFieldOffset(BaseLinkedQueueProducerNodeRef.class, "producerNode");
    private volatile LinkedQueueNode<E> producerNode;

    final void spProducerNode(LinkedQueueNode<E> newValue)
    {
        UNSAFE.putReference(this, P_NODE_OFFSET, newValue);
    }

    final void soProducerNode(LinkedQueueNode<E> newValue)
    {
        UNSAFE.putReferenceRelease(this, P_NODE_OFFSET, newValue);
    }
    ...
    {
        return UNSAFE.compareAndSetReference(this, P_NODE_OFFSET, expect, newValue);
    }
...
{
    private final static long               C_NODE_OFFSET = UNSAFE.objectFieldOffset(BaseLinkedQueueConsumerNodeRef.class, "consumerNode");
    ...
    {
        return (LinkedQueueNode<E>) UNSAFE.getReferenceVolatile(this, C_NODE_OFFSET);
    }
